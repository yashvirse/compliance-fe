...
import {
  ...
  fetchUserById,
  clearError,
} from "./slice/CustomerAdminUser.Slice";
import {
  selectUserLoading,
  selectUserError,
...
import type {
  AddUserRequest,
  EditUserRequest,
} from "./slice/CustomerAdminUser.Type";
...
const AddCustomerAdminUserPage: React.FC = () => {
    ...
    if (isEditMode && id) {
      const loadUser = async () => {
        try {
          ...
          if (user.userImage) {
            setImagePreview(`${IMAGE_BASE_URL}${user.userImage}`);
          }
        } catch (err) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.userMobile.trim())
      newErrors.userMobile = "Mobile is required";
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      bgcolor: passwordStrength.hasMinLength
                        ? "success.main"
                        : "grey.300",
                    }}
                  />
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      bgcolor: passwordStrength.hasUpperCase
                        ? "success.main"
                        : "grey.300",
                    }}
                  />
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      bgcolor: passwordStrength.hasNumber
                        ? "success.main"
                        : "grey.300",
                    }}
                  />
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      bgcolor: passwordStrength.hasSpecialChar
                        ? "success.main"
                        : "grey.300",
                    }}
                  />
