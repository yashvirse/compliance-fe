  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(addCompany.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.payload || "An error occurred while adding company";
        state.success = false;
      })
      ...
      .addCase(fetchCompanyList.rejected, (state, action) => {
        state.fetchLoading = false;
        state.fetchError =
          action.payload || "An error occurred while fetching companies";
      })
      ...
      .addCase(deleteCompany.rejected, (state, action) => {
        state.deleteLoading = false;
        state.deleteError =
          action.payload || "An error occurred while deleting company";
        state.deleteSuccess = false;
      })
      ...
      .addCase(fetchCompanyById.rejected, (state, action) => {
        ...
        state.fetchByIdError =
          action.payload || "An error occurred while fetching company details";
        state.currentCompany = null;
      })
